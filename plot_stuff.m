%run after random-forest-discriminator.m

close all
labels={'Total Fibrosis Burden','ML Region Percentage','ML in RD Area','ML Proportion in RD Area','ML in Non RD Area','Fibrosis density','Fibrosis entropy','Lesion perim.','Lesion area','Lesion perim over area','min-EFA','Euclid','Dijkstra','Borderiness, LA','Borderiness, RA','# PSs','#PSs No Duplicates','# PS clusters (e = .05)','# PS clusters (e = .1)','Lesion AR','Lesion FF','Lesion R','Lesion Con','Dijstra to LIPV','Dijstra to LSPV','Dijkstra to RIPV','Dijstra to RSPV','Dijkstra to IVC','Dijstra to SVC','Dijstra to MV','Dijstra to TV','Euclid to LIPV','Euclid to LSPV','Euclid to RIPV','Euclid to RSPV','Euclid to IVC','Euclid to SVC','Euclid to MV','Euclid to TV','Min Dijkstra to PVs','Min Euclid to PVs'};
for i=1:size(M,2)
    figure
